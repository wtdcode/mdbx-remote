...
impl Environment {
    ...
    ///
    /// ```
    /// # use libmdbx_remote::Environment;
...
impl From<EnvironmentBuilder> for RemoteEnvironmentConfig {
    fn from(value: EnvironmentBuilder) -> Self {
        Self {
            flags: value.flags,
            max_readers: value.max_readers,
            max_dbs: value.max_dbs,
            sync_bytes: value.sync_bytes,
            sync_period: value.sync_period,
            rp_augment_limit: value.rp_augment_limit,
            loose_limit: value.loose_limit,
            dp_reserve_limit: value.dp_reserve_limit,
            txn_dp_limit: value.txn_dp_limit,
            spill_max_denominator: value.spill_max_denominator,
            spill_min_denominator: value.spill_min_denominator,
